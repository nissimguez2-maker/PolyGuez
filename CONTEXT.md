...
**Refreshed at:** 2026-04-15T20:48:18+00:00 (UTC) — commit `a8ab5bd` by nissimguez2-maker
...
- `8a3fa4d` 2026-04-15 fix: rolling-stats reconciliation — add corruption warning and document tiebreaker invariant
- `65661f1` 2026-04-15 fix: session tag mismatch — add helper table and startup warning
- `5b05c79` 2026-04-15 fix: remove pdb import and breakpoints from production code
...
_error: 404 Client Error: Not Found for url: https://rapmxqnxsobvxqtfnwqh.supabase.co/rest/v1/session_tag_current?select=tag&limit=1_
<!-- LIVE_STATE_END -->
