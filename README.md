...
If you encounter issues while using the agents:

- Make sure you're using Python 3.9+  
- Reinstall dependencies using `pip install -r requirements.txt`  
- Verify your API credentials and environment variables  
- Check open issues: https://github.com/Polymarket/agents/issues  

These steps fix most common problems users run into.
