...
This repository is intended for developers who want to experiment with automated agents interacting with Polymarket markets.  
Review the example files to understand common usage patterns before extending the agents.
